...
<div id="login"><h1><a href="<?php echo apply_filters('login_headerurl', bloginfo('url')); ?>" title="<?php echo apply_filters('login_headertitle', 'Идеи и Идеалы. Научный журнал.'); ?>"><?php bloginfo('name'); ?></a></h1>
<?php
