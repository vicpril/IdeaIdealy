		...
		if ( substr($wp_version, 0, 3) < '2.5' ) {
			...
			if ( $body && $options['custom_field_template_replace_the_title'] ) :
				...
				$out .=	'jQuery(document).ready(function() {                    //yearno0_0     god zhur
					...
					var yearno0_0=jQuery("#yearno0_0").val();     //получаем значение из пол€ √ќƒ. если оно пустое значит это нова€ запись, можно брать параметры из кук и заполн€ть все нужные пол€

					if(!yearno0_0){

                    var yearno0_0 = GetCookie("yearno0_0");
                    if(yearno0_0){jQuery("#yearno0_0").val(yearno0_0);}

					var no1_0 = GetCookie("no1_0");
                    if(no1_0){jQuery("#no1_0").val(no1_0);}

                    var tom2_0 = GetCookie("tom2_0");
                    if(tom2_0){jQuery("#tom2_0").val(tom2_0);}
                    }


					var yearno0_0=jQuery("#yearno0_0").val();
					var no1_0=jQuery("#no1_0").val();
					var tom2_0=jQuery("#tom2_0").val();

					//вносим данные полей снова в куки

					//setCookie("yearno0_0", yearno0_0, "Mon, 01-Jan-2021 00:00:00 GMT", "/");
					//setCookie("no1_0", no1_0, "Mon, 01-Jan-2021 00:00:00 GMT", "/");
					//setCookie("tom2_0", tom2_0, "Mon, 01-Jan-2021 00:00:00 GMT", "/");

					jQuery("#yearno0_0").focus(function() {
					    var yearno0_0=jQuery("#yearno0_0").val();
					    setCookie("yearno0_0", yearno0_0, "Mon, 01-Jan-2021 00:00:00 GMT", "/");
					});
					jQuery("#yearno0_0").change(function() {
					    var yearno0_0=jQuery("#yearno0_0").val();
					    setCookie("yearno0_0", yearno0_0, "Mon, 01-Jan-2021 00:00:00 GMT", "/");
					});
					jQuery("#yearno0_0").keyup(function() {
					    var yearno0_0=jQuery("#yearno0_0").val();
					    setCookie("yearno0_0", yearno0_0, "Mon, 01-Jan-2021 00:00:00 GMT", "/");
					});

					jQuery("#no1_0").change(function() {
					    var no1_0=jQuery("#no1_0").val();
					    setCookie("no1_0", no1_0, "Mon, 01-Jan-2021 00:00:00 GMT", "/");
					});

					jQuery("#tom2_0").change(function() {
					    var tom2_0=jQuery("#tom2_0").val();
					    setCookie("tom2_0", tom2_0, "Mon, 01-Jan-2021 00:00:00 GMT", "/");
					});

					jQuery(\'#cftdiv h3 span\').text(\'' . $options['custom_fields'][$init_id]['title'] . '\');});' . "\n";
				$out .= '// ]]>' . "\n" . '</script>';
			endif;
		}
