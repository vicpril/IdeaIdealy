...
function update_meta_cache($meta_type, $object_ids) {
	...
	{		$ordercoaut=" order by meta_id ASC ";	}
	// end xaver add

	//xaver add $ordercoaut
	$meta_list = $wpdb->get_results( $wpdb->prepare("SELECT $column, meta_key, meta_value FROM $table WHERE $column IN ($id_list) $ordercoaut",
		$meta_type), ARRAY_A );
