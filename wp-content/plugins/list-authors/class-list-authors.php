...
class ListAuthorsWidget extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        <!-- List Authors -->
          <?php wp_list_authors2('optioncount='.$options['optioncount'].'&exclude_admin='.$options['exclude_admin'].'&show_fullname='.$options['show_fullname'].'&hide_empty='.$options['hide_empty'].$feed_image.'&style='.$options['style']);

          //optioncount=1&exclude_admin=1&show_fullname=1&hide_empty=&style=list
