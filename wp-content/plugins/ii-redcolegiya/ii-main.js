...
function get_raw_template(i, type, val, options) {
    temp = '<tr pos="' + i + '" class="raw-user">                            <td>                                <input type="text" hidden="" "="" value="' + val + '" raw_type="' + type + '" name="data[' + type + '][' + i + '][groupe]">                            </td>                                <td>                                    <input type="text" value="" placeholder="Должность" style="width: 250px;" pos="' + i + '" name="data[' + type + '][' + i + '][post]" class="post">                            </td>                                 <td>                                <input type="text" class="post-en" name="data[' + type + '][' + i + '][post_en]" pos="' + i + '" style="width: 250px;" placeholder="Должность - eng" value="" />                            </td>                           <td>                                <select style="width: 350px; " pos="' + i + '" class="users" name="data[' + type + '][' + i + '][user_id]" type="text"> ' + options + '                </select></td>                            <td>                                <input type="button" value="+" style="margin-left: 20px; margin-right: 2px;" pos="' + i + '" class="add-users button">                            </td>                            <td>                                <input type="button" value="X" style="margin-left: 2px; margin-right: 20px;" pos="' + i + '" class="remove-users button">                            </td>                        </tr>';
        return temp;
