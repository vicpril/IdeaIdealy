...
<div class="info">
                      ...
                      <p style="float:right;display:inline;padding-right:40px;padding-top:5px" class="info-list-box2">
                        ...
                        <!--<div style="float:right;padding-right:40px;"><small>При нажатии на активную клавишу [Аннотация] и [Текст] вы можете перейти<br>соответственно к тексту аннотации или статьи</small></div>-->

                    <div class="info-list"><ul class="article-list">
...
//				if(function_exists(wt_the_coauthors_link) && (array_pop(get_post_custom_values('stol')) !== 'yes')): wt_the_coauthors_link("<b>","</b>"); endif;
                ...
                if(function_exists(wt_the_coauthors_link) && (array_pop($stol) !== 'yes')): wt_the_coauthors_link("<b>","</b>"); endif;
                    ?>  
                    ...
                    <!--end DOI-->
                     ...
                     <br><div class="info-list-box" id="<?=$post->ID?>_line">
                        ...
                        <? if(!isset($excerpt['no'])){ ?>
                            <a href="" <?=$excerpt["js"]?> title="Аннотация" class="ss<?=$excerpt["no"]?>">Аннотация</a>
                        <? } ?>
