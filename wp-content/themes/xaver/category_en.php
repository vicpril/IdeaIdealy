...
//				global $post;
                ...
                if ($yearno < 2016) {
                   ...
                   ?>
					...
					<a style='font-size:16px;font-weight:bold;text-decoration:none' href="<?=$permalink ?>" rel="bookmark" title="Go to the article: <?=$title_en?>"><?=$title_en?></a><? echo " / <div style='display:inline' class='crumbs'>$link_archive &raquo; $link_no"; ?>
