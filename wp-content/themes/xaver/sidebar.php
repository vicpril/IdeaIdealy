...
//           'nopaging' => 0, 'post_status' => 'publish', 'caller_get_posts' => 1, 'lang' => ''));
//
...
<div class="right-side">
	...
	<div class="right-box obshenie">
        <h2><?php pll_e('ДИСКУССИОННЫЙ КЛУБ'); ?></h2>
...
wp_reset_query();
		...
		?>
             <a style="float:right" href="/diskussionnye-kluby"><?php pll_e('Посмотреть все'); ?></a>
	</div>
